...
#locations for nne
names(nne) <- paste("location",json_data$data$meta$ll, sep="_")
#add the dates
...
#locations for nst
names(nst) <- paste("location",json_data$data$meta$ll, sep="_")
#add dates for nst
...
Get api’s for years of 1983-4, 1998-9, 2016-7 for CA
